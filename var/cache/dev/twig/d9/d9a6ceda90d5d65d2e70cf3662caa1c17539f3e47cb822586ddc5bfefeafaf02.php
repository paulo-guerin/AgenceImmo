...
class __TwigTemplate_d151e1bc9f30fce463ea01ecd8ef599b7a03724985f84efb3ad00de16cb77091 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card-body\">
        ...
        // line 11
        echo "            <a href=\"";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("property.show", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["property"]) || array_key_exists("property", $context) ? $context["property"] : (function () { throw new RuntimeError('Variable "property" does not exist.', 11, $this->source); })()), "id", [], "any", false, false, false, 11), "slug" => twig_get_attribute($this->env, $this->source, (isset($context["property"]) || array_key_exists("property", $context) ? $context["property"] : (function () { throw new RuntimeError('Variable "property" does not exist.', 11, $this->source); })()), "slug", [], "any", false, false, false, 11)]), "html", null, true);
        echo "\">";
        ...
        // line 14
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["property"]) || array_key_exists("property", $context) ? $context["property"] : (function () { throw new RuntimeError('Variable "property" does not exist.', 14, $this->source); })()), "formatedPrice", [], "any", false, false, false, 14), "html", null, true);
        echo " €</div>
    </div>
</div>";
    ...
    {
        return array (  81 => 14,  73 => 13,  65 => 11,  60 => 7,  54 => 5,  48 => 3,  46 => 2,  43 => 1,);
    }
