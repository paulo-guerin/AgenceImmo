...
class __TwigTemplate_8760d9f5859f53e7190e5fa0391d6f64876bc3496c8d942b158603fe0322a5a1 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card-body\">
        ...
        <p class=\"card-text\">";
        // line 6
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["property"]) || array_key_exists("property", $context) ? $context["property"] : (function () { throw new RuntimeError('Variable "property" does not exist.', 6, $this->source); })()), "surface", [], "any", false, false, false, 6), "html", null, true);
        echo " m² - ";
    ...
    {
        return array (  64 => 8,  55 => 6,  48 => 4,  43 => 1,);
    }
