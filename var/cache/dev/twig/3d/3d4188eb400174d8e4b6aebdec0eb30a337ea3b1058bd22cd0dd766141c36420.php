...
class __TwigTemplate_5c25cba8892f8b38fc05ef8516f8081ece421295e9ed684ee3c6a2f1690a522c extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container mt-4\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
            ...
            echo "\" class=\"btn btn-secondary\">Editer</a>
                            <a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin.option.delete", ["id" => twig_get_attribute($this->env, $this->source, $context["option"], "id", [], "any", false, false, false, 29), "_token" => $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . twig_get_attribute($this->env, $this->source, $context["option"], "id", [], "any", false, false, false, 29)))]), "html", null, true);
...
";
    ...
    {
        return array (  153 => 37,  147 => 33,  137 => 29,  133 => 28,  128 => 26,  121 => 24,  110 => 15,  101 => 12,  98 => 11,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
                ...
                {% for option in options %}               
                    <tr>
                        ...
                        <td>
                            ...
                            <a href=\"{{ path('admin.option.delete', {id: option.id, _token: csrf_token ( 'delete' ~ option.id )}) }}\" class=\"btn btn-danger\">Supprimer</a>
                        </td>
                    </tr>
                {% endfor %}
            </tbody>
