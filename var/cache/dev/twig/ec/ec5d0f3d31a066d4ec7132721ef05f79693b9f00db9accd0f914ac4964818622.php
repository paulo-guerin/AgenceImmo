...
class __TwigTemplate_601d46279443241826b75d090a12017c86ad94722a427f45ec742d7edb3007b5 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container mt-4\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["property"]) {
            ...
            echo "\" class=\"btn btn-secondary\">Editer</a>
                            <a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin.property.delete", ["id" => twig_get_attribute($this->env, $this->source, $context["property"], "id", [], "any", false, false, false, 29), "_token" => $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . twig_get_attribute($this->env, $this->source, $context["property"], "id", [], "any", false, false, false, 29)))]), "html", null, true);
                ...
                {% for property in properties %}               
                    <tr>
                        ...
                        <td>
                            ...
                            <a href=\"{{ path('admin.property.delete', {id: property.id, _token: csrf_token ( 'delete' ~ property.id )}) }}\" class=\"btn btn-danger\">Supprimer</a>
                        </td>
                    </tr>
                {% endfor %}
            </tbody>
