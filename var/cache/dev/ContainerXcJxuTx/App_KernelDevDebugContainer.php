...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_Authentication_Provider_Dao_MainService()
    {
        ...
        return $this->privates['security.authentication.provider.dao.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(($this->privates['security.user.provider.concrete.in_memory'] ?? $this->getSecurity_User_Provider_Concrete_InMemoryService()), new \Symfony\Component\Security\Core\User\UserChecker(), 'main', ($this->privates['security.encoder_factory.generic'] ?? ($this->privates['security.encoder_factory.generic'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory([]))), true);
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        return $this->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['demo' => ['password' => 'demo', 'roles' => [0 => 'ROLE_ADMIN']]]);
    }
