...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        return $this->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['demo' => ['password' => 'demo', 'roles' => []]]);
    }
