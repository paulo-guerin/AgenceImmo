...
class App_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.Rrwn3Oo' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Rrwn3OoService()
    {
        return $this->privates['.service_locator.Rrwn3Oo'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getContactNotificationService()
    {
        ...
        return $this->privates['App\\Notification\\ContactNotification'] = new \App\Notification\ContactNotification(new \Symfony\Component\Mailer\Mailer((new \Symfony\Component\Mailer\Transport(new RewindableGenerator(function () {
        ...
        }, 3)))->fromStrings(['main' => $this->getEnv('MAILER_DSN')]), NULL, ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService())), ($this->services['twig'] ?? $this->getTwigService()));
    }
