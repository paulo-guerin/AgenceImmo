...
return [
    ...
    'option_index' => [[], ['_controller' => 'App\\Controller\\OptionController::index'], [], [['text', '/option/']], [], []],
    'option_new' => [[], ['_controller' => 'App\\Controller\\OptionController::new'], [], [['text', '/option/new']], [], []],
    'option_show' => [['id'], ['_controller' => 'App\\Controller\\OptionController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/option']], [], []],
    'option_edit' => [['id'], ['_controller' => 'App\\Controller\\OptionController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/option']], [], []],
    'option_delete' => [['id'], ['_controller' => 'App\\Controller\\OptionController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/option']], [], []],
